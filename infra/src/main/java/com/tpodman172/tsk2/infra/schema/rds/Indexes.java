...
public class Indexes {
    ...
    public static final Index ACHIEVEMENT_PRIMARY = Indexes0.ACHIEVEMENT_PRIMARY;
    ...
    private static class Indexes0 {
        public static Index ACHIEVEMENT_PRIMARY = Internal.createIndex("PRIMARY", Achievement.ACHIEVEMENT, new OrderField[] { Achievement.ACHIEVEMENT.TASK_ID, Achievement.ACHIEVEMENT.TARGET_DATE }, true);
